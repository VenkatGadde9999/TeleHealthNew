...
@WebServlet(name = "edit_appointment", urlPatterns = {"/editappointment"})
    ...
    HttpSession session = null;
      ...
      protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet edit_appointment</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet edit_appointment at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//String photo= request.getParameter("photo");
 ...
 //================================
            ...
            pstmt = conn.prepareStatement("update  appointmentslot set slotdate=?,prev_attend=?,summary=?,anyreport=?,reportfilename=? where appointmentid=?");
            pstmt.setString(1, dateofappointment);
            pstmt.setString(2, pevatt);
            ...
            if (row > 0) {
                ...
                out.println("alert('Appointment Request Updated');");
                out.println("location='bookappointment.jsp';");
                out.println("</script></html>");

            } else {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Appointment update failed');");
                out.println("location='bookappointment.jsp';");
                out.println("</script>");
            }
        } catch (Exception ex) {
