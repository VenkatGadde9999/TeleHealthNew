...
messageText+="<h1>to activate click the link and enter the code<a href=\'http://localhost:8084/TelHealth/patient/forgetpasswordactivate.jsp?userid="+email+"\'>Click Here</a></h1>";
...
out.println("<html><script>alert('Sending Verification code failed');"
            + "window.location='patientforgetpassword.jsp';</script></html> "); // assume  a fail
