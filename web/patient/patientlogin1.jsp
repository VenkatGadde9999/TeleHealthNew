...
String sss1 = "select * from patientlogin where patientid='"+userid+"' and password='"+pwd+"'";

ResultSet rs1=st1.executeQuery(sss1);
if(rs1.next())
{
session.setAttribute("userid", userid);
session.setAttribute("plogin", "true");    
...
if(status.equalsIgnoreCase("active"))
    response.sendRedirect("patienthome.jsp?message=success");
else
