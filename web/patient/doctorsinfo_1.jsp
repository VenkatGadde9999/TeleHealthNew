...
<%    Connection con1 = null;
    ...
    try {
        con1 = databasecon.getconnection();
                ...
                PreparedStatement pstmt1 = con1.prepareStatement("select name,gender,specialization,qualification,institute_name,procurement_year,experience from doctorinfo,docspecialization where doctorinfo.doctorid=docspecialization.doctorid and  doctorinfo.doctorid='" + did + "'");
