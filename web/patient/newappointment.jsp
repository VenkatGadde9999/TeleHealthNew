<%-- 
    ...
    Created on : 19 Jun, 2021, 11:13:08 PM
...
<div class="wrapper bg-white" style="max-width:85%;" >
    ...
    <table  width="1500"  >
        ...
        <th rowspan="7"style="width: 650px;padding-right: 250px;">
        ...
        <tr>
            <td >
                ...
                <form name="update" class="pt-3" action="addnewappointment.jsp?doctorid=<%= did %>"  method="post" >
