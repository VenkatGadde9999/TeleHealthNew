...
pstmt=con1.prepareStatement("update patientlogin set `firstname`=?,`lastname`=?,`password`=? where `patientid`=?");
...
{
//out.println(e1);
    out.println("<html><script>alert( error in patient profile page:\'"+e1+"\');</script></html> ");
}
finally{
    try
    {
