...
PreparedStatement pstmt = con1.prepareStatement("insert into patientlogin values(?,?,?,?,?)");
...
if(x>0)
{
    response.sendRedirect("GenerateEmailToPatient.jsp");
    out.println("<html><script>alert('Successfully registered\nActivation code send to your email');"
            + "window.location=\'patient/activate.jsp?userid="+email+"\';</script></html> ");
