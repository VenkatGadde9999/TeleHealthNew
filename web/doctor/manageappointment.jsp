...
//Connection con1 = databasecon.getconnection();
        PreparedStatement pstmt = con1.prepareStatement("select * from appointmentslot where doctorid=?");
        ...
        <center>
            <div class="container-tbl">
                <form name="addcompany" action="#" method="post">
                    <div style="position:relative;right:-430px;padding:20px;"><button class="btn" style="background-color:orange;" type="submit">Welcome Doctor: To Approve the Appointment Clik on Edit</button-->
                    </div>
                </form>
                <form name="info" method="post">
                    <table class="table table-light table-striped table-bordered table-hover " width="1200" align=center>
                        <thead class="tblheader">
                            <tr>
                                <td>Sno<td>Appointment Id<td> Patient Id<td>Date<td>Status<td>Edit</td><td>Delete</td>
                            </tr>
                        </thead>
                        <%                        int n = 1;
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="patientinfo.jsp?patientid=<%=  rs1.getString("patientid")%>" id="viewdoctor">
