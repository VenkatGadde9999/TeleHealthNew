...
<body>
         <%
    if( session.getAttribute("dlogin")==null ||session.getAttribute("dlogin")=="false")
    {
				...
				<div class="row">
					<div class="col">
						<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
                                                    <div class="top_bar_item"><a href="#">Welcome <%=session.getAttribute("dname")%></a></div>
							...
							<nav class="main_nav ml-auto">
								<ul>
									...
									<li><a href="personalinfo.jsp">Person Info</a></li>
                                                                        <li><a href="specializationinfo.jsp">Specialization Info</a></li>
