...
String subject="TeleHealth - Doctor Account Activation";//(String)session.getAttribute("subject");
//String subject ="welcome";

String messageText ="Secret Key : <b>"+securitycode+"</b>";
messageText+="<h1>to activate click the link and enter the code<a href=\'http://localhost:8084/TelHealth/doctor/activate.jsp?userid="+email+"\'>Click Here</a></h1>";
...
out.println("location=\'doctor/activate.jsp?userid="+email+"\';");
out.println("</script>");
