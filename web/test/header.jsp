				...
				<div class="row">
					<div class="col">
						<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
							<!-- div class="top_bar_item"><a href="login.jsp">login</a></div>
							<div class="top_bar_item"><a href="doctoreditinfo.jsp">Doctor Info</a></div>
							<div class="top_bar_item"><a href="AppoinmentsHistory.jsp">Appointment History</a></div>
